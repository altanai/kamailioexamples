...
function ksr_route_withindlg(request_method)
    ...
    if request_method == "BYE" then
        ...
        KSR.log("info", "mos average " .. KSR.pv.getvn("$avp(mos_average)", 0) .. "\n ")
        KSR.log("info", "mos_average_packetloss " .. KSR.pv.getvn("$avp(mos_average_packetloss)",0).. "\n ")
        KSR.log("info", "mos_average_jitter " .. KSR.pv.getvn("$avp(mos_average_jitter)",0).. "\n ")
        KSR.log("info", "mos_average_roundtrip " .. KSR.pv.getvn("$avp(mos_average_roundtrip)",0).. "\n ")
        KSR.log("info", "mos_average_samples " .. KSR.pv.getvn("$avp(mos_average_samples)",0).. "\n ")

        KSR.log("info", "mos_min " .. KSR.pv.getvn("$avp(mos_min)",0).. "\n ")
        KSR.log("info", "mos_min_at " .. KSR.pv.getvn("$avp(mos_min_at)",0).. "\n ")
        KSR.log("info", "mos_min_packetloss " .. KSR.pv.getvn("$avp(mos_min_packetloss)",0).. "\n ")
        KSR.log("info", "mos_min_jitter " .. KSR.pv.getvn("$avp(mos_min_jitter)",0).. "\n ")
        KSR.log("info", "mos_min_roundtrip " .. KSR.pv.getvn("$avp(mos_min_roundtrip)",0).. "\n ")

        KSR.log("info", "mos_max " .. KSR.pv.getvn("$avp(mos_max)",0).. "\n ")
        KSR.log("info", "mos_max_at " .. KSR.pv.getvn("$avp(mos_max_at)",0).. "\n ")
        KSR.log("info", "mos_max_packetloss " .. KSR.pv.getvn("$avp(mos_max_packetloss)",0).. "\n ")
        KSR.log("info", "mos_max_jitter " .. KSR.pv.getvn("$avp(mos_max_jitter)",0).. "\n ")
        KSR.log("info", "mos_max_roundtrip " .. KSR.pv.getvn("$avp(mos_max_roundtrip)",0).. "\n ")
        ...
        KSR.log("info", "mos_B_label " .. KSR.pv.getvn("$avp(mos_B_label)",1) .. "\n ")
        KSR.log("info", "mos_average_packetloss_B " .. KSR.pv.getvn("$avp(mos_average_packetloss_B)", 0) .. "\n ")
        KSR.log("info", "mos_average_jitter_B " .. KSR.pv.getvn("$avp(mos_average_jitter_B)", 0) .. "\n ")
        KSR.log("info", "mos_average_roundtrip_B " .. KSR.pv.getvn("$avp(mos_average_roundtrip_B)", 0) .. "\n ")
